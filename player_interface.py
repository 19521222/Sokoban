...
class PlayerInterface:
    def __init__(self, player, level):
        ...
        self.txtNextLevel = "Next Level"
        self.colortxtNextLevel = SOKOBAN.BLACK
    ...
    def click(self, pos_click, level, game):
        ...
        if x > self.posTxtNextLevel[0] and x < self.posTxtNextLevel[0] + self.txtNextLevelSurface.get_width() \
        and y > self.posTxtNextLevel[1] and y < self.posTxtNextLevel[1] + self.txtNextLevelSurface.get_height():
            game.nextlvl()
    ...
    def render(self, window, level):
        ...
        self.txtNextLevelSurface = self.font_menu.render(self.txtNextLevel, True, self.colortxtNextLevel, SOKOBAN.WHITE)
        self.posTxtNextLevel = ((SOKOBAN.WINDOW_WIDTH - self.txtNextLevelSurface.get_width()) - 10, 50)
        window.blit(self.txtNextLevelSurface, self.posTxtNextLevel)